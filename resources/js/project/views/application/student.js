        ...
        <form className="mb-4">
              ...
              <FormGroup>
                ...
                <FormText color="danger">
                  <i>
                    ...
                    photograph, All in one file.(Vital)
                  </i>
                </FormText>
              </FormGroup>
            </Col>
          ...
          <Row>
            ...
            <Label check className="p-4">
              <Input type="checkbox" onChange={declaring} /> I confirm that the
              information I have provided is a representation of all my/our
              personal, academic, professional, organizational profile.
            ...
            {submitError === "error occuired" ? (
              <Alert
                ...
                isOpen={visible}
                toggle={onDismiss}>
                <strong className="mr-5">Error Occured While applying</strong>
                <br />
                Please Apply again
              </Alert>
            ) : null}
